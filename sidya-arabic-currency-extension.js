(function () {
  ...
  var ar = {
    ...
    orderCurrentUnitPrice: "السعر الحالي للوحدة",
    orderRequestedUnitPrice: "سعر الوحدة المطلوب",
    orderCurrentTotal: "الإجمالي الحالي",
    orderRequestedTotal: "الإجمالي المطلوب",
    orderPriceDifference: "فرق السعر",
    orderDiscountRate: "نسبة الخصم المطلوبة",
    orderCurrentSubtotal: "إجمالي السعر الحالي",
    orderRequestedSubtotal: "إجمالي السعر المطلوب",
    orderAverageDiscount: "متوسط الخصم المطلوب",
    orderTaxTotal: "الضريبة (الحالي / المطلوب)",
    orderGrandTotals: "الإجمالي العام (الحالي / المطلوب)",
    orderExchangeRates: "أسعار الصرف الحالية",
    orderRateUnavailable: "أسعار الصرف غير متاحة مؤقتًا.",
    orderRequestedPriceInvalid: "أدخل سعرًا مطلوبًا صالحًا.",
