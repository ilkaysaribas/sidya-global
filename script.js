const content = {
  en: {
    ...
    b2bServerMissing: "Direct document email is not active yet. Opening email draft.",
  ...
  tr: {
    ...
    b2bServerMissing: "Doğrudan evrak mail servisi henüz aktif değil. Mail taslağı açılıyor.",
