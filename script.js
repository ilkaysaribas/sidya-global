...
const content = {
  en: {
    ...
    gtipSeoCopy: "GTIP is TÃ¼rkiye's 12-digit customs tariff statistical position code. The first 6 digits follow the international HS system; the final classification must be checked with product composition, use, packaging and official tariff sources.",
    ...
    introCopy:
      "Sidya Global is a Trabzon, TÃ¼rkiye based export-focused trading platform connecting manufacturers and brand partners with international buyers.",
    missionTitle: "Our mission",
    missionCopy: "To help buyers reach t…54838 tokens truncated…erId = `SG-${now.toISOString().replace(/\D/g, "").slice(0, 17)}`;
