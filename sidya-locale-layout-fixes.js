(function () {
  ...
  var KEY_FALLBACKS = {
    ...
    en: {
      ...
      heroCopy: "Sidya Global helps international buyers source high-quality Turkish products quickly, transparently, and professionally.",
  ...
  function ensureStyle() {
    ...
    style.textContent = [
      ...
      ".site-container{width:100%;max-width:1440px;margin-inline:auto;padding-inline:clamp(24px,5vw,96px);}",
      ...
      ".hero-content{max-width:600px;margin:0;text-align:start;inset-inline:auto;}",
      ".hero-metrics{max-width:min(1180px,calc(100vw - 24px));text-align:start;}",
      ...
      "@media (max-width:760px){.site-header{padding-inline:12px}.brand{flex-basis:100%;justify-content:center}.nav-links{gap:8px}.nav-links a{font-size:12px}.header-actions{flex-basis:100%;}.top-contact-links{justify-content:center}.lang-switch{grid-template-columns:repeat(3,minmax(0,1fr));width:100%;}.lang-option{justify-content:center}.site-container{padding-inline:24px}.hero-content{max-width:600px;padding-inline:0}.hero-metrics{max-width:calc(100vw - 24px);gap:8px}.exchange-rate-heading,.exchange-rate-list{width:100%;justify-content:center}.products-menu{max-width:calc(100vw - 16px);}}",
