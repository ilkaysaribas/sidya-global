...
function sendBackendScript(res) {
  ...
  res.status(200).send(`
    ...
    (function(){
      ...
      function loadSiteEnhancements(){ renderBuildInfo(); if (!/\\/admin(?:\\.html)?$/.test(location.pathname)) { appendStyle("sidyaAiAssistantStyles", "/sidya-ai-assistant.css?v=20260722-1"); appendScript("sidyaAiAssistantScript", "/sidya-ai-assistant.js?v=20260722-1"); } if (document.getElementById("quoteForm")) { appendScript("sidyaMailCrmRouteShimScript", "/mail-crm-route-shim.js?v=20260711-1"); appendScript("sidyaSiteMailCrmScript", "/site-mail-crm.js?v=20260711-1"); } }
