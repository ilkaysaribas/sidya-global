...
const assertions = [
  ...
  [worker.includes("sidya-global-v120"), "Service worker cache version was not advanced"],
...
if (!worker.includes('sidya-global-v120')) throw new Error('Service worker cache version is stale.');
